...
MediaUpload.prototype.__init = function(params, file_size, media_type, media_category) {
	...
	return new Promise(function(resolve, reject) {
		...
		self.__twitter.post('media/upload', upload_params).then(function(data) {
			resolve(data);
		}).catch(function(err) {
			resolve(err);
		});
...
MediaUpload.prototype.__append = function(chunk_data, chunk_id) {
	...
	return new Promise(function(resolve, reject) {
		...
		self.__twitter.post('media/upload', upload_params).then(function() {
			resolve();
		}).catch(function(err) {
			reject(err);
		});
...
MediaUpload.prototype.__finalize = function() {
    ...
    return self.__twitter.post('media/upload', upload_params).then(function(data) {
...
MediaUpload.prototype.__status = function() {
	...
	return new Promise(function(resolve, reject) {
		...
		self.__twitter.get('media/upload', upload_params).then(function(data) {
			resolve(data);
		}).catch(function(err) {
			reject(err);
		});
